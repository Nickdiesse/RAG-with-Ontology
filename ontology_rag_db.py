...
with open(r"C:\Users\nicol\Desktop\progetto_tesi\Ontology_rag\sweet.json") as f:
...
# Connect to RDF file
rdf_graph = load_rdf_data(r"C:\Users\nicol\Desktop\progetto_tesi\Ontology_rag\ontology_earth_owl.xrdf")
...
def process_questions(questions, graph):
    ...
    insert_query = """
    INSERT INTO rag_ontology (id, question_text, ground_truth, answer_orca, answer_llama, answer_falcon, 
